...
//  digitalWrite (STEPBUTTON1, INPUT);
//  digitalWrite (STEPBUTTON2, INPUT);
//  digitalWrite (STEPBUTTON3, INPUT);
//  digitalWrite (STEPBUTTON4, INPUT);
//  digitalWrite (STEPBUTTON5, INPUT);
//  digitalWrite (STEPBUTTON6, INPUT);
//  digitalWrite (STEPBUTTON7, INPUT);
//  digitalWrite (STEPBUTTON8, INPUT);
